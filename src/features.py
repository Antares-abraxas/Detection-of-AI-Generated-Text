...
Реализует набор синтаксических и пунктуационных дескрипторов согласно:
  - Гипотезе №1 (синтаксическая шаблонность): CR-POS, уникальные POS-шаблоны 
  - Гипотезе №2 (пунктуационная однородность): энтропия пунктуации, burstiness, CV запятых 
  - Гипотезе №3 (стилистическая «гладкость»): TTR, доля причастий/деепричастий 
  - Гипотезе №4 (семантико-структурное несоответствие): глубина дерева зависимостей 
"""
